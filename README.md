# Online Bus Reservation Platform

Scalable bus transit ticketing and reservation platform built with Django offering route discovery, seat booking, ticket issuance, and customer management.
...
- **Technologies**: Django 4+, SQLite, HTML5, CSS3, JavaScript, Python 3.11
- **Lead Developer**: MASA
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/XREFS0/masa-django-bus-booking.git
   cd masa-django-bus-booking
   ```
